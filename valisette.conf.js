export default {
   ...
   * */
  JS_MAIN_OUTPUT: "[name]-[contenthash].js", // js file output name pattern
  ...
  CSS_MAIN_OUTPUT: "[name]-[contenthash].css", // css file output name pattern (used in production mode)
